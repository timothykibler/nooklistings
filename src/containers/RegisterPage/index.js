...
function RegisterPage({ children }) {
  ...
  return (
    <Flex justify='center' direction='column' alignItems='center'>
      ...
      >
        <FieldInput name='name' placeholder={t('translation:name')} onChange={handleChange.bind(this)} />
        ...
        <FieldInput name='password2' placeholder={t('translation:retypepassword')} type='password' onChange={handleChange.bind(this)} />
      </FormCard>
    </Flex>
  )
